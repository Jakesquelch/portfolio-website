...
export function Footer() {
  return (
    <footer className="relative px-6 pb-12 md:pb-16">
      <div className="mx-auto flex max-w-5xl flex-col items-center gap-5 border-t border-foreground/10 pt-10 md:pt-12">
        <div className="flex items-center gap-3">
          <a
            ...
            rel="noreferrer"
            aria-label="LinkedIn"
            className="glass inline-flex h-10 w-10 items-center justify-center rounded-full text-foreground/70 transition-all hover:-translate-y-px hover:bg-foreground/10 hover:text-foreground"
          >
